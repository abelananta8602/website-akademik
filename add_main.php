...
<body>
    <div class="header">
        <div class="title">Tambah Mahasiswa</div>
    </div>
    <div class="breadcrumb">
        <a href="main.php">Mahasiswa</a> > <a href="add_main.php" class="active">Tambah Mahasiswa</a>
    </div>
    ...
    <div class="popup" id="popup">
        ...
        <div class="actions">
            <a href="main.php" class="nav-link">KEMBALI</a>
            <a style="color: grey; font-size:14px" href="add_main.php" class="nav-link2">TAMBAH DATA BARU</a>
        </div>
    </div>

...
<body>
    ...
    <h3 style="font-family:merriweather; font-weight:bold;margin-top:30px; margin-left:350px">Kegiatan</h3>
    <div id="main" class="container mt-5">
        <div class="controls mb-3">
            ...
            if ($result->num_rows > 0) {
                echo "<button onclick=\"window.location.href='add_kegiatan.php'\" class=\"btn btn-tambah-data\">Tambah Data</button>";
            }
            ?>
        </div>
        ...
        if ($result->num_rows > 0) {
            ...
            echo '<thead><tr><th scope="col"><input type="checkbox" id="select-all"></th><th scope="col">Nama Kegiatan</th><th scope="col">Deskripsi</th><th scope="col">Waktu</th><th scope="col">Tempat</th><th scope="col">Actions</th></tr></thead>';
            echo '<tbody>';
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td><a href='edit_kegiatan.php?id={$row['id']}' class='edit-link'>Edit</a></td>";
                echo "</tr>";
            }
            echo '</tbody></table>';
        } else {
            ...
            <div class='left-content'>
                ...
                <button onclick=\"window.location.href='add_kegiatan.php'\" class='btn btn-tambah-data'>TAMBAH DATA</button>
            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            confirmDeleteBtn.addEventListener('click', function() {
                if (selectedIds.length > 0) {
                    window.location.href = 'kegiatan.php?delete=' + selectedIds.join(',');
                }
            });
        });
    </script>
